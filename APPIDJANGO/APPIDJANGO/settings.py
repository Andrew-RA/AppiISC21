"""
Django settings for APPIDJANGO project.
...
SECRET_KEY = 'django-insecure-s6=2(bwfv5o-^6j+=#0k#+)dc-08^vnoav)c_m*ice8ch)7cm4'
...
WSGI_APPLICATION = 'APPIDJANGO.wsgi.application'
